...
clear;
echo -e "  \033[1;37m${Font_Purple}Media Stream Unlocker Test${Font_Suffix}\033[0m";
echo -e "  \033[1;37mVersion : 1.0 \033[0m";
...
echo -e ""
echo -e "Script Mod By EZ-Code"
echo ""
read -p "$( echo -e "Press ${orange}[ ${NC}${Font_Green}Enter${Font_White} ${CYAN}]${Font_White} back to main menu . . .") "
menu
